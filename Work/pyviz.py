...
--> python3 pyviz.py `ruby -e "puts (100..200).to_a.shuffle.join(' ')"`
...
class PsGui:
    def __init__(self, master):
        ...
        self.PrevCtl = Button(self.butframe, text=" - ", fg="black", command=self.speed_down)
        self.PrevCtl.pack(side=LEFT)
        self.PauseCtl = Button(self.butframe, text=" Start ", fg="black", command=self.pause)
        self.PauseCtl.pack(side=LEFT)
        self.NextCtl = Button(self.butframe, text=" + ", fg="black", command=self.speed_up)
        self.NextCtl.pack(side=LEFT)
        self.ResetCtl = Button(self.butframe, fg="black", text=" Reset ", command=self.reset)
        self.ResetCtl.pack(side=LEFT)
        self.listbox = Listbox(self.toolframe,bd=2, bg='black', fg='white',
    ...
    def reset(self):
        ...
        self.draw_rectangles()
        self.listbox.see(0)
        self.PauseCtl.config(text='Start')
        self.launch()
    ...
    def pause(self):
        if self.speed != 0:
            ...
            self.PauseCtl.config(text='Pause')
